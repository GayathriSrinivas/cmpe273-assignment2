...
import edu.sjsu.cmpe.library.domain.QueueProducer;
import edu.sjsu.cmpe.library.domain.TopicListener;
...
public class BookResource {
    ...
    public BookResource(BookRepositoryInterface bookRepository,
		 ...
		 queueProducer = new QueueProducer(configuration);
		 queueProducer.initialise();
    ...
    public BooksDto getAllBooks() {
		...
		booksResponse.addLink(new LinkDto("create-books", "/books", "POST"));
